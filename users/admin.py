...
class CustomUserAdmin(admin.ModelAdmin):
    list_display = ('email', 'phone', 'is_owner', 'is_staff', 'is_active', 'is_online', 'created_at', 'updated_at')
...
class CustomerVerificationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__email', 'user__phone', 'first_name', 'last_name', 'document_number')
